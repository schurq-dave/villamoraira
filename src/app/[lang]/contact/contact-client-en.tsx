...
interface ContactClientPageENProps {
  pageData: {
    hero: {
      badge: string
      title: string
...
export default function ContactClientPageEN({
  pageData,
  navigationItems,
  languageOptions,
  footerConfig,
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Breadcrumb items={[{ name: "Home", url: `/${locale}` }, { name: "Contact" }]} />
